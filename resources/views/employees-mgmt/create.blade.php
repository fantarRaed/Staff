        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="/staff-management" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control js-country" name="country_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control js-states" name="state_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control js-cities" name="city_id" required >
